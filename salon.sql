...
INSERT INTO public.services VALUES (4, 'Gel X');
INSERT INTO public.services VALUES (5, 'Foot Spa');
...
--
-- Name: appointments appoinment_customer; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appoinment_customer FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);
